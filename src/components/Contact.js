                    ...
                    <Grid item xs={12} md={6}>
                        <Box className={addressField}>
                            <Typography variantMapping={{p:'p'}} variant="p">
                               <Typography variant="body"><LocationCityIcon></LocationCityIcon></Typography>: Loxmikola,Deuli<br></br>
                                Shibganj,Bogura<br></br>
                                Bangladesh
                            </Typography>
                            <Typography variantMapping={{p:'p'}} variant="p">
                                <Typography variant="body"><MailIcon></MailIcon></Typography>: rabiulislam12360@gmail.com
                            </Typography>
                            <Typography variantMapping={{p:'p'}} variant="p">
                                <Typography variant="body"><CallIcon></CallIcon></Typography>: +880 1784014307
                            </Typography>
                        </Box>
                    </Grid>
                    <Grid item xs={12} md={6}>
